      ...
      <main className="aula-container">
        <div className="aula-header">
          <div className="aula-breadcrumb">
            <a href="/">Início</a> &gt; <a href="/modulos">Módulo 1</a> &gt; <span>Aula 1</span>
          </div>
          <h1>💡 Acendendo um LED</h1>
        ...
        <div className="aula-content">
          ...
          <section className="aula-section objetivos">
            <h2>🎯 Objetivos</h2>
            <ul>
              <li>Conhecer os componentes básicos: LED, resistor e Arduino Uno</li>
              <li>Entender a diferença entre positivo (ânodo) e negativo (cátodo)</li>
              <li>Montar o circuito corretamente na protoboard</li>
              <li>Carregar o código para acender o LED</li>
            </ul>
          </section>
...
`}
            ...
            <img 
             src={circuitoImg} 
             alt="Circuito montado - LED acendendo no Arduino"
          ...
          <section className="aula-section codigo">
            <h2>💻 Código — Acender LED</h2>
            <div className="codigo-container">
              <div className="codigo-header">
                <span className="codigo-linguagem">Arduino C++</span>
                <button className="btn-copiar" onClick={() => {
                  navigator.clipboard.writeText(document.getElementById('codigo-led').textContent);
                  alert('Código copiado! 📋');
                }}>
                  📋 Copiar código
                </button>
              </div>
              <pre className="codigo-pre" id="codigo-led">
{`// Código para acender um LED no pino 13
...
void loop() {
  digitalWrite(13, HIGH);  // Liga o LED (nível HIGH)
}`}
              </pre>
            </div>
          ...
          <section className="aula-section desafio">
            ...
            <div className="desafio-box">
              <p><strong>Modifique o código para usar o pino 12 em vez do 13.</strong></p>
              <details className="desafio-resposta">
                <summary>💡 Ver solução</summary>
                <pre className="codigo-pre">
{`void setup() {
  pinMode(12, OUTPUT);  // Mude para 12
}
  ...
  digitalWrite(12, HIGH);  // Liga o LED
          ...
          <section className="aula-section perguntas">
            ...
            <ul className="perguntas-lista">
              <li>O que acontece se você ligar o LED ao contrário?</li>
              <li>Por que usamos um resistor?</li>
              <li>O que significa a função <code>pinMode()</code>?</li>
            </ul>
          </section>
          ...
          <section className="aula-section checklist">
            ...
            <div className="checklist-items">
              ...
              <label className="checklist-item">
                <input type="checkbox" /> O LED acendeu! 🎉
              </label>
            </div>
          </section>
          ...
          <section className="aula-section erros">
            ...
            <table className="erros-tabela">
              ...
              <tbody>
                ...
                <tr>
                  <td>LED não acende</td>
                  <td>Confirme se o resistor está bem conectado</td>
                </tr>
                <tr>
                  <td>LED não acende</td>
                  <td>Veja se o pino 13 está correto no código</td>
                </tr>
                <tr>
         ...
         <div className="aula-navegacao">
          ...
          <a href="/intro/aula/2" className="btn-proximo">Próxima Aula →</a>
        </div>
      </main>
